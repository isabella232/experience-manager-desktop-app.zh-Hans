...
使用Experience manager桌面应用程序执行的主要任务有：

![使用Experience Manager桌面应用程序可完成的工作流和任务使用Adobe Experience Manager桌](assets/aem_desktop_app_usecases_v2.png "面应用程序可完成的工作流和")任 [务下载此](assets/aem_desktop_app_usecases_print.pdf) 可打印的PDF文件。
