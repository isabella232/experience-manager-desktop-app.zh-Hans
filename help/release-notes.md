...
以下是最新桌面应用程序版本2.1(2.1.2.0)的发行信息。 发行日期为2021年3月26日。 它是一个次要版本，提供了增强功能。
